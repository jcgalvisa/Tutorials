...
model = DiscreteModelFromFile("Bola.msh")

# ╔═╡ c868b48c-c810-45b4-829e-1892cf45292b
model.grid.reffes
...
begin
	...
	V0 = TestFESpace(model,reffe;conformity=:H1,dirichlet_tags="Bdry")
end
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "28771be5efd7db55a5cbc5570fd3268051ae895d"
